...
namespace ABCUnity
{
    public class Layout : MonoBehaviour
    {
        ...
        [HideInInspector] public List<VoiceLayout> layouts = new List<VoiceLayout>();
        [HideInInspector] public Dictionary<ABC.Beam, Beam> beams;
        public ABC.Tune tune { get; private set; }
        [HideInInspector] public GameObject scoreContainer;
        public Dictionary<int, GameObject> gameObjectMap { get; } = new Dictionary<int, GameObject>();
        [HideInInspector] public Dictionary<int, VoiceLayout.ScoreLine.Element> abcItemToLayoutElement { get; } = new Dictionary<int, VoiceLayout.ScoreLine.Element>();
        [HideInInspector] public  Dictionary<int, List<SpriteRenderer>> spriteRendererCache = new Dictionary<int, List<SpriteRenderer>>();
